    ...
    for message in all_messages[:msgcount]:
        ...
        try:
            ...
            if "Message successfully sent" in output.decode('utf-8'):
                print(f"{counter}." + color_yellow + current_time + color_reset + color_green + " Message sent successfuly." + color_reset)
            else:
                print(f"{counter}." + color_yellow + current_time + color_reset + color_red + " Something went wrong." + color_reset)
            counter += 1
